...
class GraphLabCanvas extends Canvas {
                                    ...
                                    double x3, double y3)
    {
         ...
         if(n!=0)
         {
        	 double midx1 = (x1 + x3)/2, midx2 = (x2 + x1)/2, midx3 = (x3 + x2)/2, midy1 = (y1 + y3)/2, midy2 = (y2 + y1)/2, midy3 = (y3 + y2)/2;
        	 sierp(g,n-1,x1,y1,midx1,midy1,midx2,midy2);
        	 sierp(g, n-1, midx1, midy1, x3, y3, midx3, midy3);
        	 sierp(g, n-1, midx2, midy2, midx3, midy3, x2,y2);
         }// TODO: put your code here
    }
    ...
    void tree(GraphicPen g, int n, double x, double y, double length, double angle) {
    	  ...
    	  g.setColor(Color.black);
          g.setLineWidth(n);
          double x1 = x + polarX(length,angle), y1 = y + polarY(length,angle);
          g.drawLine(x, y, x1, y1);
          tree(g, n-1, x1, y1, length * leftLength, angle + leftAngle);
          tree(g, n-1, x1, y1, length * rightLength, angle - rightAngle);// TODO: put your code here
    }        
